...
class TestCompleteWorkflows:
    ...
    def test_create_worktree_workflow(self, mock_location, mock_base_branch, mock_branch_name):
    ...
    def test_keyboard_interrupt_handling(self):
        ...
        with patch('git_worktree_manager.worktree_manager.WorktreeManager.create_worktree') as mock_create:
    ...
    def test_error_message_quality(self):
        ...
        with patch('git_worktree_manager.git_ops.GitOperations.list_worktrees') as mock_list:
    ...
    def test_performance_with_mock_data(self):
        ...
        with patch('git_worktree_manager.worktree_manager.WorktreeManager.list_worktrees') as mock_list:
...
class TestCLIIntegration:
    ...
    def test_all_components_importable(self):
        ...
        from git_worktree_manager import (
            cli, worktree_manager, git_ops, ui_controller, 
            config, models, exceptions, cache, error_recovery
        )
