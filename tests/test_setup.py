...
class TestPackageSetup:
    ...
    def test_package_metadata(self):
        ...
        from git_worktree_manager import cli
        from git_worktree_manager import worktree_manager
        from git_worktree_manager import git_ops
        from git_worktree_manager import ui_controller
        from git_worktree_manager import config
    ...
    def test_readme_exists(self):
        ...
        assert "Installation" in content  # Could be "## Installation" or "📦 Installation"
