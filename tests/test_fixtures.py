...
class MockGitOperations:
    ...
    def _setup_default_behaviors(self):
        ...
        # Worktree operations
        self.mock.list_worktrees.return_value = TestFixtures.create_sample_worktree_list()
        self.mock.create_worktree.return_value = None
        
        # Commit operations
        self.mock.get_commit_info.return_value = TestFixtures.create_sample_commit_info()
        
        # Diff operations
        self.mock.get_diff_summary.return_value = TestFixtures.create_sample_diff_summary()
...
class GitCommandMocker:
    ...
    @staticmethod
    def mock_git_command_failure(returncode: int = 128, stderr: str = "Git error") -> MagicMock:
